...
\item 
def \mbox{\hyperlink{namespacego__to__point_ab67d5248fa9314fd19feebdb901e70ee}{clbk\+\_\+consts}} (msg\+\_\+consts)
\item 
...
\end{DoxyVerb}
 \mbox{\Hypertarget{namespacego__to__point_ab67d5248fa9314fd19feebdb901e70ee}\label{namespacego__to__point_ab67d5248fa9314fd19feebdb901e70ee}} 
\index{go\_to\_point@{go\_to\_point}!clbk\_consts@{clbk\_consts}}
\index{clbk\_consts@{clbk\_consts}!go\_to\_point@{go\_to\_point}}
...
\begin{DoxyVerb}    Callback function used to update the linear and angular constants
    used during the motion.

    Args:
        msg_consts ([float,float]): contains the new linear and angular constants \end{DoxyVerb}
...
\begin{DoxyVerb}    Callback function used to check the actual position of the 
    ...
    Args:
        msg (Odometry): contains the position and orientation of the robot\end{DoxyVerb}
...
\begin{DoxyVerb}    Function used to fix the actual yaw angle in order to allow
    ...
    Args:
        des_pos (Point): actual goal position used to fix the yaw angle of the robot.\end{DoxyVerb}
...
\begin{DoxyVerb}    Function used to normalize the angle
    ...
    Returns:
        angle (float): angle, passed as parameter, normalized\end{DoxyVerb}
